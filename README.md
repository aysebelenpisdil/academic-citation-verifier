...
| `OPENALEX_MAILTO` | OpenAlex API'nin "polite pool"una girmek için e-posta. Daha hızlı yanıt alınır. | Hayır |
...
### Test için hazır atıf listesi

Projenin kök dizinindeki `test-citations.md` dosyası, 5 gerçek ve 5 halüsinasyon atıf içerir. Farklı halüsinasyon türlerini kapsar: tamamen uydurulmuş atıf, gerçek dergi + sahte makale, gerçek yazar + yanlış başlık vb. Dosyanın içeriğini kopyalayıp metin alanına yapıştırarak uygulamayı test edebilirsiniz.
